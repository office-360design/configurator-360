...
Copy `src/server/server.js`, `src/client/index.html`, and `package.json` over the corresponding files
in the configurator project.

Keep the existing `src/client/svg/`, `cad/source/`, `cad/intermediate/`, and conversion files.
