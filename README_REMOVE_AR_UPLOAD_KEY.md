...
4. Deploy by running `DEPLOY_NETLIFY_WITH_FUNCTIONS.cmd`.
...
The updater modifies source files and their `static-site` copies when present. It also updates `.env.example` and the Supabase/Netlify setup documentation.
