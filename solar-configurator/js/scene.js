...
export class RoofScene {
  constructor(host) {
    ...
    this.compactRenderer = window.matchMedia('(max-width: 760px), (pointer: coarse)').matches;
    this.renderer.setPixelRatio(Math.min(window.devicePixelRatio, this.compactRenderer ? 1.5 : 2));
  ...
  addLights() {
    ...
    const shadowMapSize = this.compactRenderer ? 1024 : 2048;
