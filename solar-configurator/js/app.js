...
import { RoofScene } from './scene.js?v=20';
...
// showing the defaults and rebuilding afterwards.
const sharedSolarState = await readShareState({ productType: 'solar' });
if (sharedSolarState) applySolarShareState(sharedSolarState, state);
