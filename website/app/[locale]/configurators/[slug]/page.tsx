...
export default async function LocaleConfigurator({ params }: Props) { const { locale, slug } = await params; if (!isLocale(locale) || locale === "en") throw new Error(`Unexpected locale route: ${locale}`); return <LocalizedConfiguratorPage locale={locale} slug={slug} />; }
