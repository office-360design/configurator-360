...
const EN = {
  ...
  'layout.l': 'L-shaped',
  'layout.u': 'U-shaped',
  'layout.closed': 'Closed perimeter',
...
const RO = {
  ...
  'section.layout': 'Formă și dimensiuni', 'layout.type': 'Forma gardului', 'layout.straight': 'Linie dreaptă', 'layout.l': 'Formă L', 'layout.u': 'Formă U', 'layout.closed': 'Perimetru închis',
  'dimension.runA': 'Latura A', 'dimension.runB': 'Latura B', 'dimension.runC': 'Latura C', 'dimension.closedRunA': 'Latura AB', 'dimension.closedRunB': 'Latura BC', 'dimension.closedRunC': 'Latura CD', 'dimension.closedRunD': 'Latura DA · calculată', 'dimension.closedHelp': 'DA se actualizează automat pentru a închide perimetrul.', 'dimension.angleB': 'Unghiul în B', 'dimension.height': 'Înălțime gard', 'dimension.bayWidth': 'Lățime țintă travee', 'dimension.bayHint': '{count} travei · {width} lățime medie', 'dimension.baySystem': 'Sistem de travei',
  ...
  'section.access': 'Acces și montaj', 'gate.type': 'Poartă', 'gate.none': 'Fără poartă', 'gate.pedestrian': 'Poartă pietonală', 'gate.driveway': 'Poartă auto dublă', 'gate.run': 'Latura porții', 'gate.position': 'Poziția porții', 'gate.handing': 'Sens poartă pietonală', 'gate.left': 'Balamale stânga', 'gate.right': 'Balamale dreapta', 'gate.positionHint': 'Traveea {from}{to}',
...
const DE = {
  ...
  'section.layout': 'Verlauf & Maße', 'layout.type': 'Zaunverlauf', 'layout.straight': 'Gerade', 'layout.l': 'L-Form', 'layout.u': 'U-Form', 'layout.closed': 'Geschlossener Umfang',
  'dimension.runA': 'Strecke A', 'dimension.runB': 'Strecke B', 'dimension.runC': 'Strecke C', 'dimension.closedRunA': 'Seite AB', 'dimension.closedRunB': 'Seite BC', 'dimension.closedRunC': 'Seite CD', 'dimension.closedRunD': 'Seite DA · berechnet', 'dimension.closedHelp': 'DA wird automatisch angepasst, damit der Umfang geschlossen bleibt.', 'dimension.angleB': 'Winkel bei B', 'dimension.height': 'Zaunhöhe', 'dimension.bayWidth': 'Ziel-Feldbreite', 'dimension.bayHint': '{count} Felder · {width} mittlere Breite', 'dimension.baySystem': 'Feldsystem',
  ...
  'section.access': 'Zugang & Montage', 'gate.type': 'Tor', 'gate.none': 'Kein Tor', 'gate.pedestrian': 'Personentor', 'gate.driveway': 'Doppelflügeltor', 'gate.run': 'Torstrecke', 'gate.position': 'Torposition', 'gate.handing': 'Anschlag Personentor', 'gate.left': 'Bänder links', 'gate.right': 'Bänder rechts', 'gate.positionHint': 'Feld {from}{to}',
  ...
  'section.summary': 'Zusammenfassung & Preis', 'summary.totalLabel': 'Indikativer Gesamtpreis', 'summary.totalHelp': 'Demo-Schätzung vor Steuern. Finale Planung, Aufmaß und Angebot erforderlich.', 'summary.length': 'Zaunlänge', 'summary.bays': 'Zaunfelder', 'summary.posts': 'Pfosten', 'summary.gate': 'Tor', 'summary.noGate': 'Keins', 'summary.materials': 'Material', 'summary.installation': 'Montagezuschlag', 'summary.engineering': 'Planungszuschlag', 'summary.bom': 'Stückliste', 'summary.itemCount': '{count} Positionen', 'summary.export': 'BOM als CSV exportieren', 'summary.fullBom': 'Vollständige Stückliste',
