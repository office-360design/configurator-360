...
const RO = {
  ...
  'section.layout': 'Formă și dimensiuni', 'layout.type': 'Forma gardului', 'layout.straight': 'Linie dreaptă', 'layout.l': 'Formă L', 'layout.u': 'Formă U',
  'dimension.runA': 'Latura A', 'dimension.runB': 'Latura B', 'dimension.runC': 'Latura C', 'dimension.height': 'Înălțime gard', 'dimension.bayWidth': 'Lățime țintă travee', 'dimension.bayHint': '{count} travei · {width} lățime medie', 'dimension.baySystem': 'Sistem de travei',
...
const DE = {
  ...
  'section.layout': 'Verlauf & Maße', 'layout.type': 'Zaunverlauf', 'layout.straight': 'Gerade', 'layout.l': 'L-Form', 'layout.u': 'U-Form',
  'dimension.runA': 'Strecke A', 'dimension.runB': 'Strecke B', 'dimension.runC': 'Strecke C', 'dimension.height': 'Zaunhöhe', 'dimension.bayWidth': 'Ziel-Feldbreite', 'dimension.bayHint': '{count} Felder · {width} mittlere Breite', 'dimension.baySystem': 'Feldsystem',
