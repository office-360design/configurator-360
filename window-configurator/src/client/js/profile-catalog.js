...
export const ACCESSORY_GROUPS = freeze({
    ...
    'trans-end-cap': accessoryGroup({
        id: 'trans-end-cap',
        label: 'Trans end cap',
        description: 'Top and bottom sealing caps for the floating trans profile.',
        configurationKey: 'transEndCap',
        urlParameter: 'trans_end_cap',
        aliases: ['trans_end_cap', 'transEndCap'],
...
export const PROFILE_CATALOG = freeze({
    ...
    '575820': baseAluminiumProfile({
        ...
        label: '575820',
        profileClass: 'trans',
        sourceDwg: 'cad/source/trans/575820_d1.dwg',
        structuralRoles: ['trans', 'floating-sash-adapter'],
        closesAgainst: ['opening-sash'],
        legacyProfileSets: [],
        compatibleAccessories: {
            glazingSystems: [DEFAULT_GLAZING_SYSTEM_ID],
        },
        generatedSvg: 'svg/standalone/profiles/trans/575820/profile.svg',
        generatedMetadata: 'svg/standalone/profiles/trans/575820/profile.meta.json',
        runtimeRegistered: true,
    }),
    '575830': baseAluminiumProfile({
        ...
        label: '575830',
        profileClass: 'trans',
        sourceDwg: 'cad/source/trans/575830_d1.dwg',
        structuralRoles: ['trans', 'floating-sash-adapter'],
        closesAgainst: ['opening-sash'],
        legacyProfileSets: [],
        compatibleAccessories: {
        ...
        generatedSvg: 'svg/standalone/profiles/trans/575830/profile.svg',
        generatedMetadata: 'svg/standalone/profiles/trans/575830/profile.meta.json',
        runtimeRegistered: true,
    }),
    ...
    '200953': profileAccessory({
        id: '200953',
        label: '200953 trans end cap',
        description: 'Trans end cap; geometry is not yet present in the project.',
        componentType: 'end-cap',
        accessoryType: 'trans-end-cap',
        status: 'geometry-missing',
        aliases: ['200953_s'],
    }),
    '200954': profileAccessory({
        id: '200954',
        label: '200954 trans end cap',
        description: 'Trans end cap variant; geometry is not yet present in the project.',
        componentType: 'end-cap',
        accessoryType: 'trans-end-cap',
        status: 'geometry-missing',
        aliases: ['200954_s'],
