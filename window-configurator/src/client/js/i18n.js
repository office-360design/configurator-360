const MESSAGES = Object.freeze({
  'en-US': Object.freeze({
    ...
    'accessory.group.double-vent-end-cap.label': 'Double-vent end cap',
    'accessory.group.double-vent-end-cap.description': 'Top and bottom sealing caps for the floating double-vent profile.',
  ...
  'ro-RO': Object.freeze({
    ...
    'accessory.group.double-vent-end-cap.label': 'Capac capăt cercevea dublă',
    'accessory.group.double-vent-end-cap.description': 'Capace de etanșare sus și jos pentru profilul flotant de cercevea dublă.',
    ...
    'ar.stats.meshes': 'Mesh-uri: {source} sursă → {merged} mesh-uri combinate la export',
    ...
    'ar.stats.roundTrip': 'Verificare round-trip: {meshes} mesh-uri / {triangles} triunghiuri',
  ...
  'de-DE': Object.freeze({
    ...
    'accessory.group.double-vent-end-cap.label': 'Endkappe Doppelflügel',
    'accessory.group.double-vent-end-cap.description': 'Obere und untere Dichtkappen für das schwimmende Doppelflügelprofil.',
